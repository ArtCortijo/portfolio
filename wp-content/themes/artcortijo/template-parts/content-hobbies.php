<section class="info hobbies">
  <div class="appear-up info__wrapper">
    ...
    <dl>
      ...
      <dt><?php _e('Voyager (quand il n\'y a pas de pandémie)','artcortijo'); ?></dt>
      <dt><?php _e('Me renseigner/essayer de nouvelles technos','artcortijo'); ?></dt>
      <dt><?php _e('Allez voir les expositions d\'art','artcortijo'); ?></dt>
    </dl>
  </div>
</section>
